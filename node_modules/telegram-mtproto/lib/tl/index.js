...
class Serialization {
  ...
  storeObject(obj, type, field) {
    switch (type) {
      ...
      case 'int128':
        return (0, _writer.writeIntBytes)(this.writer, obj, 128, field);
      case 'int256':
        return (0, _writer.writeIntBytes)(this.writer, obj, 256, field);
      case 'int512':
        return (0, _writer.writeIntBytes)(this.writer, obj, 512, field);
      case 'string':
        return (0, _writer.writeBytes)(this.writer, obj, `${field}:string`);
      case 'bytes':
        return (0, _writer.writeBytes)(this.writer, obj, field);
      case 'double':
    ...
    if (this.mtproto && isOverrided) {
      ...
      for (var _iterator5 = constructorData.params, _isArray5 = Array.isArray(_iterator5), _i6 = 0, _iterator5 = _isArray5 ? _iterator5 : _iterator5[Symbol.iterator]();;) {
        ...
        if (type.indexOf('?') !== -1) {
          ...
          if (!(result[fieldName] & 1 << fieldBit[1])) continue;
          type = condType[1];
        }
        var paramName = param.name;

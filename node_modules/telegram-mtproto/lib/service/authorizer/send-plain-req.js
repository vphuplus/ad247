...
var SendPlain = uid => {
  ...
  var onlySendPlainErr = err => {
    ...
    _configProvider2.default.emit(uid)([uid, 'response-raw'], error);
  ...
  var onlySendPlainRes = ({ url, req }) => {
    ...
    try {
      ...
      _configProvider2.default.emit(uid)([uid, 'response-raw'], _error);
      return _bluebird2.default.reject(_error);
    }
    _configProvider2.default.emit(uid)([uid, 'response-raw'], {
      data: req.data,
      status: req.status,

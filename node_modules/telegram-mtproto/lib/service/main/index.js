...
class MTProto {
  constructor(config) {
    ...
    this.processMessage = ({ threadID, message }) => {
      var networker = this.state.threads.get(threadID);
    ...
    var { uid, next } = (0, _configProvider.curriedRegister)();
    next({
      signIn: false,
      emit: this.emit,

...
exports.parsedResponse = exports.readHash = exports.getDataWithPad = exports.readResponse = undefined;
...
var readResponse = exports.readResponse = ({ response, reader, authKeyStored }) => {
...
function* _ref2({ authKey, msgKey, encryptedData }) {
...
var readHash = exports.readHash = ({ reader, currentSession, prevSession, dataWithPadding }) => {
...
function* _ref4({ hashData, msgKey, reader }) {

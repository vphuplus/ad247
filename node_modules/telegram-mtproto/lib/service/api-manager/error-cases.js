...
var noDcAuth = ({ dcID, reject, apiSavedNet, apiRecall, deferResolve, invoke }) => {
  var importAuth = ({ id, bytes }) => invoke('auth.importAuthorization', { id, bytes }, { dcID, noErrorBox: true, dc: dcID });

  if ((0, _ramda.isNil)(cachedExportPromise[dcID])) {
...
var waitFail = ({ options, throwNext, requestThunk }) => {
  ...
  } else options.stopTime = now + (0, _ramda.propOr)(10, 'timeout', options) * 1000;
